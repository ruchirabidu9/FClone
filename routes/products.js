...
const supervisior = require('../middlewares/supervisior.js');
...
router.post('/', [authe, supervisior], async (req, res) => {
...
router.put('/:id', [authe, supervisior], async (req, res) => {
...
router.delete('/:id', [authe, supervisior], async (req, res) => {
